...
import 'package:surveyvor_lite/screens/register_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  loginAttempt() async {
    ...
    http.Response response = await http.post(
      Uri.parse('https://surveyvor.shocklogic.com/api/auth/login'),
      headers: {
    ...
    if(response.statusCode == 200){
      ...
      globals.token = data["token_type"]+" "+data["access_token"];
      Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => SurveyListScreen()));
    }else{
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text("Whoops! Wrong Credentials"),
      ));
    }
  }
