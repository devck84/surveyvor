...
function SocketsProvider(props) {
  ...
  socket.on(_config_events__WEBPACK_IMPORTED_MODULE_5__.default.SERVER.ROOMS, value => {
    ...
    let chats;
    axios__WEBPACK_IMPORTED_MODULE_6___default().get("https://surveyvor.shocklogic.com/api/chat/mine", headers).then(d => {
      chats = d.data.chat;
    }); // @ts-ignore
  ...
  socket.on(_config_events__WEBPACK_IMPORTED_MODULE_5__.default.SERVER.JOINED_ROOM, value => {
    setRoomId(value);
    setMessages([]);
  });
  (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
